        ...
        switch(this.var){
            case 1:
                try{
                    ...
                    PrgState crtPrgState = new PrgState(ex1, execStack, new MyDictionary<String, IValue>(),new MyList<>(), new MyDictionary<StringValue,BufferedReader>(), new MyHeap(), new LatchTable());
            ...
            case 2:
                try{
                    ...
                    PrgState crtPrgState = new PrgState(ex2, execStack, new MyDictionary<String, IValue>(),new MyList<>(), new MyDictionary<StringValue,BufferedReader>(), new MyHeap());
                    IRepository repo = new Repository("logFile.txt");
                    //repo.addPrgState(crtPrgState);
                    Controller controller = new Controller(repo);
                    controller.allStep();
            ...
            case 3:
                try{
                    ...
                    PrgState crtPrgState = new PrgState(ex3, execStack, new MyDictionary<String, IValue>(),new MyList<>(), new MyDictionary<StringValue,BufferedReader>(), new MyHeap());
                    IRepository repo = new Repository("logFile.txt");
                    //repo.addPrgState(crtPrgState);
                    Controller controller = new Controller(repo);
                    controller.allStep();
